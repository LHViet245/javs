...
| Everyday operator | [Commands](./commands.md) |
| User tuning config and behavior | [Configuration](./configuration.md) |
| User troubleshooting a problem | [Troubleshooting](./troubleshooting.md) |
...
If you previously used `docs/USAGE.md` as the all-in-one guide, use the pages above instead. This file is intentionally short so the real docs stay focused and do not drift apart.
